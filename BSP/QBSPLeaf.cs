...
namespace SharpQuake
{
    ...
    internal struct QBSPLeaf
    {
        ...
        [MarshalAs( UnmanagedType.ByValArray, SizeConst = QBSPAmbientFlag.NUM_AMBIENTS )]
        public byte[] ambient_level; // [NUM_AMBIENTS];

        public static int SizeInBytes = Marshal.SizeOf( typeof( QBSPLeaf ) );
    }
}
