...
namespace SharpQuake
{
    ...
    internal struct QBSPFace
    {
        ...
        // lighting info
        [MarshalAs( UnmanagedType.ByValArray, SizeConst = QBSPFile.MAXLIGHTMAPS )]
        public byte[] styles; //[MAXLIGHTMAPS];

        public int lightofs; // start of [numstyles*surfsize] samples

        public static int SizeInBytes = Marshal.SizeOf( typeof( QBSPFace ) );
    }
}
