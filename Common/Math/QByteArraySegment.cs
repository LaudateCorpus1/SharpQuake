...
{
    internal class QByteArraySegment
    {
        ...
        public QByteArraySegment( byte[] array )
            : this( array, 0, -1 )
        {
        }

        public QByteArraySegment( byte[] array, int startIndex )
            : this( array, startIndex, -1 )
        {
        }

        public QByteArraySegment( byte[] array, int startIndex, int length )
        {
            if( array == null )
            {
