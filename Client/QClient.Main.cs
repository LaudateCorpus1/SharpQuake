...
namespace SharpQuake
{
    partial class QClient
    {
        ...
        /// CL_AllocDlight
        /// </summary>
        public static QDynamicLight AllocDlight( int key )
        {
            QDynamicLight dl;
        ...
        private static void RelinkEntities()
        {
            ...
            for( int i = 1; i < cl.num_entities; i++ )
            {
                ...
                if( i == cl.viewentity && !QChase.IsActive )
                    continue;
        ...
        /// CL_SignonReply
        ///
        /// An svc_signonnum has been received, perform a QClient side setup
        /// </summary>
        ...
        private static void ClearState()
        {
            ...
            foreach( QDynamicLight dl in _DLights )
                dl.Clear();
            ...
            foreach( QLightBeam b in _Beams )
                b.Clear();
