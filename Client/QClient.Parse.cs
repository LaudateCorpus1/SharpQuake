...
namespace SharpQuake
{
    partial class QClient
    {
        ...
        {
            "svc_bad", "svc_nop", "svc_disconnect", "svc_updatestat", "svc_version", // [long] server version
            "svc_setview",                                                           // [short] entity number
            "svc_sound",                                                             // <see code>
            "svc_time",                                                              // [float] server time
            "svc_print",                                                             // [string] null terminated string
            "svc_stufftext",                                                         // [string] stuffed into QClient's console buffer
            ...
            "svc_spawnstatic", "OBSOLETE svc_spawnbinary", "svc_spawnbaseline", "svc_temp_entity",                                                                // <variable>
            "svc_setpause", "svc_signonnum", "svc_centerprint", "svc_killedmonster", "svc_foundsecret", "svc_spawnstaticsound", "svc_intermission", "svc_finale", // [string] music [string] text
                ...
                switch( cmd )
                {
                    ...
                    case protocol.svc_cdtrack:
                        ...
                        if( ( cls.demoplayback || cls.demorecording ) && ( cls.forcetrack != -1 ) )
                            QCDAudio.Play( (byte) cls.forcetrack, true );
                        else
                            QCDAudio.Play( (byte) cl.cdtrack, true );
                        break;
        ...
        /// <summary>
        /// CL_ParseClientdata
        /// Server information pertaining to this QClient only
        /// </summary>
        ...
        private static void ParseServerInfo()
        {
            ...
            cl.scores = new QScoreboard[cl.maxclients]; // Hunk_AllocName (cl.maxclients*sizeof(*cl.scores), "scores");
            for( i = 0; i < cl.scores.Length; i++ )
                cl.scores[i] = new QScoreboard();
        ...
        /// <summary>
        /// CL_KeepaliveMessage
        /// When the QClient is taking a long time to load stuff, send keepalive messages
