...
namespace SharpQuake
{
    public class mainwindow : GameWindow
    {
        ...
        public static DisplayDevice DisplayDevice { get => _DisplayDevice; set => _DisplayDevice = value; }
        ...
        {
            0, QKey.K_SHIFT, QKey.K_SHIFT, QKey.K_CTRL, QKey.K_CTRL, QKey.K_ALT, QKey.K_ALT, 0,                                 // 0 - 7
            0, 0, QKey.K_F1, QKey.K_F2, QKey.K_F3, QKey.K_F4, QKey.K_F5, QKey.K_F6,                                             // 8 - 15
            QKey.K_F7, QKey.K_F8, QKey.K_F9, QKey.K_F10, QKey.K_F11, QKey.K_F12, 0, 0,                                          // 16 - 23
            0, 0, 0, 0, 0, 0, 0, 0,                                                                                             // 24 - 31
            0, 0, 0, 0, 0, 0, 0, 0,                                                                                             // 32 - 39
            0, 0, 0, 0, 0, QKey.K_UPARROW, QKey.K_DOWNARROW, QKey.K_LEFTARROW,                                                  // 40 - 47
            QKey.K_RIGHTARROW, QKey.K_ENTER, QKey.K_ESCAPE, QKey.K_SPACE, QKey.K_TAB, QKey.K_BACKSPACE, QKey.K_INS, QKey.K_DEL, // 48 - 55
            QKey.K_PGUP, QKey.K_PGDN, QKey.K_HOME, QKey.K_END, 0, 0, 0, QKey.K_PAUSE,                                           // 56 - 63
            0, 0, 0, QKey.K_INS, QKey.K_END, QKey.K_DOWNARROW, QKey.K_PGDN, QKey.K_LEFTARROW,                                   // 64 - 71
            0, QKey.K_RIGHTARROW, QKey.K_HOME, QKey.K_UPARROW, QKey.K_PGUP, (byte) '/', (byte) '*', (byte) '-',                 // 72 - 79
            (byte) '+', (byte) '.', QKey.K_ENTER, (byte) 'a', (byte) 'b', (byte) 'c', (byte) 'd', (byte) 'e',                   // 80 - 87
        ...
        public bool PromptExit { get { return false; } }
        ...
        {
            //Workaround for SDL2 mouse QInput issues
        ...
        private void Mouse_WheelChanged( object sender, OpenTK.Input.MouseWheelEventArgs e )
        {
            if( e.Delta > 0 )
            {
                QKey.Event( QKey.K_MWHEELUP, true );
                QKey.Event( QKey.K_MWHEELUP, false );
            }
            else
            {
                QKey.Event( QKey.K_MWHEELDOWN, true );
                QKey.Event( QKey.K_MWHEELDOWN, false );
            }
        }
        ...
        private void Mouse_ButtonEvent( object sender, OpenTK.Input.MouseButtonEventArgs e )
        {
            ...
            QInput.MouseEvent( _MouseBtnState );
        }
        ...
        private int MapKey( OpenTK.Input.Key srcKey )
        {
            ...
            if( _KeyTable[key] == 0 )
                QConsole.DPrint( "key 0x{0:X} has no translation\n", key );
        ...
        {
            QKey.Event( MapKey( e.Key ), false );
        }

        private void Keyboard_KeyDown( object sender, OpenTK.Input.KeyboardKeyEventArgs e )
        {
            QKey.Event( MapKey( e.Key ), true );
        }
