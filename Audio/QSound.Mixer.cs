...
namespace SharpQuake
{
    partial class QSound
    {
        ...
        private static void PaintChannels( int endtime )
        {
            while( _PaintedTime < endtime )
            {
                ...
                for( int i = 0; i < _TotalChannels; i++ )
                {
                    ...
                    QSoundFXCache sc = LoadSound( ch.sfx );
                    if( sc == null )
                        continue;
        ...
        private static void PaintChannelFrom8( QSoundChannel ch, QSoundFXCache sc, int count )
        {
            if( ch.leftvol > 255 )
                ch.leftvol = 255;
            if( ch.rightvol > 255 )
        ...
        private static void PaintChannelFrom16( QSoundChannel ch, QSoundFXCache sc, int count )
        {
